...
| 🎙️ **Aksesibilitas**| **Picture to Text (OCR)** | Ekstrak dan sisipkan teks dari gambar. |
| | **Draw to Text** | Ubah tulisan tangan menjadi teks yang dapat diedit. |
...
Langkah pertama adalah mengkloning repositori dan menginstal dependensi.
...
Setelah itu, pilih panduan pengembangan untuk platform target Anda di bawah ini.

## 📚 Panduan Pengembangan

Pilih panduan yang sesuai dengan platform Anda:

*   [** Panduan untuk Pengembang iOS**](./GUIDE_IOS.md)
